		...
		if(!empty($username)&&!empty($password)&&!empty($password_again)&&!empty($firstname)&&!empty($surname))
		{
			...
			else
			{
				...
				else
				{
					...
					$query = "SELECT username FROM login_info WHERE username='".mysqli_real_escape_string($mysql_connect, $username)."'";
					...
					{
						$query = "INSERT INTO login_info VALUES ('','".mysqli_real_escape_string($mysql_connect, $username)."','".mysqli_real_escape_string($mysql_connect, $password_hash)."','".mysqli_real_escape_string($mysql_connect, $firstname)."','".mysqli_real_escape_string($mysql_connect, $surname)."')";
